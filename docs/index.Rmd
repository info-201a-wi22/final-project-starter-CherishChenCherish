...
```
# Summary
From the dataset we found that within the **19 columns** and  **35402 rows**,Looking at the dataset we calculated the total doses and the total different vaccines to find the maximum vaccines that were administered in California counties. 
